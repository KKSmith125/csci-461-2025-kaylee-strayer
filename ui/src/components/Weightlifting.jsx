...
function Weightlifting() {
 return (
  <>
      <h1 className='text-white display-4 text-center pb-2'>Weightlifting</h1>

      <Container className='d-flex justify-content-center p-0 m-0' fluid>
        <Row className='g-0'>
          <Col>
      ...
      <Container className='justify-content-center'>
        ...
        <h1 className='text-white display-6 pt-4 pb-2'>Some General Exercises</h1>
        <p className='text-white'>
        ...
        <h5 className='text-white pt-4 pb-2'>Disclaimer</h5>
        <p className='text-white'>
        ...
        <h5 className='text-white pt-4 pb-2'>Bicep and Tricep</h5>
        <p className='text-white'>
        ...
        <h5 className='text-white pt-4 pb-2'>Back, Chest, and Shoulder</h5>
        <p className='text-white'>
        ...
        <h5 className='text-white pt-4 pb-2'>Lower Body</h5>
        <p className='text-white'>
        ...
        <h5 className='text-white pt-4 pb-2'>Core</h5>
        <p className='text-white'>
