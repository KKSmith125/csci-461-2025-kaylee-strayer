...
DO $$
  ...
  BEGIN
    ...
    INSERT INTO trainers(name, description) VALUES ('Cameron Malone', 'A trainer drawn to athletics from a young age and continues to stay fit through firefighting and weightlifting. He specializes in giving the client a plan that will help them reach their performance goals.') RETURNING id INTO cameron_trainer_id;
